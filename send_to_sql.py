...
def load_csv_to_postgres(csv_path, source_label, db_user, db_name, db_host='localhost', table_name='iot23_raw', db_port=5432, db_password=None):
...
def main():
    ...
    for csv_file in csv_files:
        ...
        load_csv_to_postgres(csv_file, source_label, db_user, db_name, db_password=db_password)
